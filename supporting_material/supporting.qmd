...
$$
\text{WRES}_{i,t} = \frac{y_{i,t} - E[y_{i,t} \mid x_i]}{\sqrt{Var[y_{i,t} \mid x_i]}} \sim \mathcal{N}(0, 1)
$$
\vspace{-1mm}
...
$$
\begin{aligned}
Var[\mu_i] & \approx \frac{d\mu_i}{d\eta_i}(\text{EBE}_i) \cdot \Omega \cdot \frac{d\mu_i}{d\eta_i}(\text{EBE}_i)^T \\
Var[\sigma_i] & \approx \frac{d\sigma_i}{d\eta_i}(\text{EBE}_i) \cdot \Omega \cdot \frac{d\sigma_i}{d\eta_i}(\text{EBE}_i)^T
\end{aligned}
$$
